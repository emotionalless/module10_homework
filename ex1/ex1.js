...
btn.addEventListener('click', () => {
    ...
    if (i == false) {
        document.querySelector(`.btn_icon`).innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-left-circle-fill" viewBox="0 0 16 16">
      ...
      i = true;
        ...
        document.querySelector(`.btn_icon`).innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-left-circle" viewBox="0 0 16 16">
